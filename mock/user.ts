    ...
    buttons: [
      {
        ...
        code: 'authority_menu_create',
        name: '菜单新建'
      },
      {
        id: '6660234fd19a93e740a65c4c',
        code: 'authority_menu_update',
        name: '菜单编辑'
      },
      {
        id: '6660234fd19a93e740a65c4d',
        code: 'authority_menu_remove',
        name: '菜单删除'
      },
      {
        id: '6660234fd19a93e740a65c4f',
        code: 'authority_button_create',
        name: '按钮新建'
      },
      {
        id: '6660234fd19a93e740a65c50',
        code: 'authority_button_update',
        name: '按钮编辑'
      },
      {
        id: '6660234fd19a93e740a65c51',
        code: 'authority_button_remove',
        name: '按钮删除'
      },
      {
        id: '6660234fd19a93e740a65c53',
        code: 'authority_role_create',
        name: '角色新建'
      },
      {
        id: '6660234fd19a93e740a65c54',
        code: 'authority_role_update',
        name: '角色编辑'
      },
      {
        id: '6660234fd19a93e740a65c55',
        code: 'authority_role_remove',
        name: '角色删除'
      },
      {
        id: '6660234fd19a93e740a65c57',
        code: 'authority_user_create',
        name: '用户新建'
      },
      {
        id: '6660234fd19a93e740a65c58',
        code: 'authority_user_update',
        name: '用户编辑'
      },
      {
        id: '6660234fd19a93e740a65c59',
        code: 'authority_user_remove',
        name: '用户删除'
      },
      {
        id: '6660234fd19a93e740a65c5a',
        code: 'authority_user_password',
        name: '用户密码'
      }
    ]
  }
...
export const userInfo = function (options: any) {
  ...
  const isAdmin = accessToken.startsWith('admin')
  const isGuest = accessToken.startsWith('guest')
  if (isAdmin) {
    return {
      code: 200,
      data: adminData
  ...
  return { code: 400, message: '无法获取用户信息' }
}
