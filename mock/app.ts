...
const en = {
  ...
  'common:menu.administrator': 'administrator',
  'common:menu.administrator-menu': 'Menu List',
  ...
  '/administrator/menu.selection': 'Selection',
  '/administrator/menu.id': 'ID',
  '/administrator/menu.name': 'Name',
  '/administrator/menu.path': 'Path',
  '/administrator/menu.icon': 'Icon',
  '/administrator/menu.parent': 'Parent',
  '/administrator/menu.create-time': 'Create time',
  '/administrator/menu.status': 'Status',
  '/administrator/menu.operations': 'Operations'
}
...
const zhCn = {
  ...
  'common:menu.administrator': '权限管理',
  'common:menu.administrator-menu': '菜单列表',
  ...
  '/administrator/menu.selection': '多选按钮',
  '/administrator/menu.id': '菜单编号',
  '/administrator/menu.name': '菜单名称',
  '/administrator/menu.path': '菜单路径',
  '/administrator/menu.icon': '菜单图标',
  '/administrator/menu.parent': '父级菜单',
  '/administrator/menu.create-time': '创建时间',
  '/administrator/menu.status': '菜单状态',
  '/administrator/menu.operations': '管理操作'
}
...
export const appTranslation = function (options: any) {
  ...
  if (url.includes('code=zhCn')) {
    ...
    } else if (url.includes('stem=%2Fadministrator%2Fmenu')) {
      return { code: 200, data: filterByPrefix(zhCn, '/administrator/menu') }
    }
  }
  ...
  if (url.includes('code=en')) {
    if (url.includes('stem=common')) {
      ...
      return { code: 200, data: filterByPrefix(en, '/administrator/menu') }
    }
  }
