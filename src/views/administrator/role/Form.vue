<template>
  <common-form ref="dom" :model :rules class="max-w-3xl mx-auto pb-20">
    <el-row :gutter="20">
    ...
    <div class="absolute left-0 bottom-0 p-4 w-full page-container text-right">
...
import { searchButton } from '@/apis/administrator/button'
...
import { SearchButtonOutput } from '@/openapi/__generated__'
