<template>
  <el-form ref="dom" :model :rules label-width="auto">
    <el-form-item prop="name" :label="$t('/authority/menu.name')">
      <el-input v-model="model.name" :placeholder="$t('common.please-input')" />
    </el-form-item>
    <el-form-item prop="path" :label="$t('/authority/menu.path')">
      <el-input v-model="model.path" :placeholder="$t('common.please-input')" />
    </el-form-item>
    <el-form-item prop="status" :label="$t('/authority/menu.status')">
      <el-select
...
import { CreateMenuInput, UpdateMenuInput } from '@/apis/authority/menu'
